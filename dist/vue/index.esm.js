import { defineComponent as n, computed as o, createElementBlock as r, openBlock as t, mergeProps as u, createCommentVNode as d, createElementVNode as C, toDisplayString as h } from "vue";
const c = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], f = { key: 0 }, y = ["fill"], p = ["fill"], w = /* @__PURE__ */ n({
  __name: "WeatherBarometer",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
    multiColor: { type: Boolean, default: !1 },
    primaryColor: {},
    secondaryColor: {},
    className: {},
    style: {},
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-barometer"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    } : e.style);
    return (l, m) => (t(), r("svg", u({
      width: l.size,
      height: l.size,
      viewBox: "0 0 32 32",
      fill: l.multiColor ? "none" : l.color,
      class: a.value,
      style: s.value,
      role: l.title ? "img" : "presentation",
      "aria-hidden": l.title ? "false" : "true",
      "aria-label": l.title
    }, l.$attrs), [
      l.title ? (t(), r("title", f, h(l.title), 1)) : d("", !0),
      C("path", {
        ...
        fill: l.multiColor ? l.primaryColor || "currentColor" : l.color
      }, null, 8, y),
      C("path", {
        ...
        fill: l.multiColor ? l.secondaryColor || "#666666" : l.color
      }, null, 8, p)
    ], 16, c));
  }
}), L = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], $ = { key: 0 }, g = ["fill"], M = ["fill"], b = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-celsius"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", $, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), v = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], Z = { key: 0 }, N = ["fill"], z = ["fill"], B = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-down"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", Z, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), W = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], S = { key: 0 }, k = ["fill"], j = ["fill"], F = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-fog"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", S, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), R = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], E = { key: 0 }, H = ["fill"], T = ["fill"], q = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-rain-single"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", E, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), A = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], G = { key: 0 }, Q = ["fill"], D = ["fill"], U = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-rain"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", G, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), V = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], P = { key: 0 }, I = ["fill"], J = ["fill"], K = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-snow-single"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", P, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), O = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], X = { key: 0 }, Y = ["fill"], _ = ["fill"], x = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-snow"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", X, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), l1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], e1 = { key: 0 }, o1 = ["fill"], r1 = ["fill"], t1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-up"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", e1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), i1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], a1 = { key: 0 }, s1 = ["fill"], C1 = ["fill"], n1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud-wind"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", a1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), u1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], d1 = { key: 0 }, h1 = ["fill"], m1 = /* @__PURE__ */ n({
  __name: "WeatherCloud",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-cloud"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", d1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), c1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], f1 = { key: 0 }, y1 = ["fill"], p1 = ["fill"], w1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-clouds"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", f1, h(l.title), 1)) : d("", !0),
      C("path", {
        d: "M9.984,23.424C6.976,23.424 4.544,20.992 4.544,17.984L4.544,17.952C4.544,14.944 6.976,12.512 9.984,12.512C7.002,12.542 4.6,14.963 4.6,17.952L4.6,17.984C4.6,20.973 7.002,23.394 9.984,23.424ZM10.792,12.596C11.3,11.837 11.969,11.212 12.742,10.759C11.987,11.212 11.334,11.837 10.84,12.608C10.824,12.604 10.808,12.6 10.792,12.596ZM15.015,9.971C16.041,7.931 18.085,6.72 20.32,6.72C23.584,6.72 26.24,9.376 26.24,12.64L26.24,12.992C27.296,13.728 27.968,14.944 27.968,16.192C27.968,18.4 26.176,20.192 24,20.192L23.412,20.192C23.453,19.974 23.477,19.749 23.48,19.52C23.48,19.147 23.426,18.781 23.323,18.432L24,18.432C25.184,18.432 26.144,17.472 26.144,16.288C26.144,15.456 25.664,14.688 24.896,14.336C24.512,14.176 24.32,13.76 24.384,13.376C24.416,13.12 24.448,12.896 24.448,12.672C24.448,10.4 22.592,8.544 20.32,8.544C19.059,8.544 17.892,9.134 17.123,10.069C16.697,9.971 16.254,9.92 15.8,9.92C15.535,9.92 15.273,9.937 15.015,9.971ZM7.215,20.331C7.88,21.126 8.875,21.632 9.984,21.632L19.456,21.632C20.64,21.632 21.6,20.672 21.6,19.488C21.6,18.73 21.202,18.025 20.55,17.64C21.235,18.017 21.656,18.741 21.656,19.52C21.656,20.704 20.696,21.664 19.512,21.664L10.04,21.664C8.898,21.664 7.883,21.144 7.215,20.331ZM20.288,17.506C19.947,17.329 19.78,16.938 19.84,16.576C19.872,16.32 19.904,16.096 19.904,15.872C19.904,14.351 19.073,13.017 17.842,12.301C19.103,13.009 19.96,14.36 19.96,15.904C19.96,16.128 19.928,16.352 19.896,16.608C19.839,16.95 19.985,17.317 20.288,17.506ZM13.007,15.173C12.715,15.354 12.339,15.357 12.032,15.168C11.648,14.88 11.104,14.56 10.56,14.432C10.368,14.4 10.176,14.4 9.984,14.4C9.516,14.4 9.075,14.487 8.673,14.642C9.096,14.467 9.557,14.368 10.04,14.368C10.264,14.368 10.52,14.4 10.776,14.464C10.808,14.464 10.84,14.496 10.872,14.496C10.904,14.496 10.936,14.528 10.968,14.528C11.384,14.688 11.8,14.944 12.088,15.136C12.375,15.313 12.724,15.322 13.007,15.173Z",
        fill: l.multiColor ? l.primaryColor || "currentColor" : l.color
      }, null, 8, y1),
      C("path", {
        d: "M9.984,12.512C10.272,12.512 10.528,12.544 10.784,12.608C10.787,12.604 10.789,12.6 10.792,12.596L10.84,12.608C11.334,11.837 11.987,11.212 12.742,10.759C13.428,10.356 14.197,10.089 15.008,9.984C15.01,9.98 15.012,9.975 15.015,9.971C15.273,9.937 15.535,9.92 15.8,9.92C16.254,9.92 16.697,9.971 17.123,10.069C17.111,10.083 17.1,10.098 17.088,10.112C19.712,10.72 21.696,13.056 21.696,15.904L21.696,16.256C22.432,16.768 22.944,17.568 23.2,18.432L23.323,18.432C23.426,18.781 23.48,19.147 23.48,19.52C23.477,19.749 23.453,19.974 23.412,20.192L23.296,20.192C22.976,22.016 21.344,23.424 19.424,23.424L9.984,23.424C7.002,23.394 4.6,20.973 4.6,17.984L4.6,17.952C4.6,14.963 7.002,12.542 9.984,12.512ZM8.673,14.642C8.195,14.827 7.772,15.108 7.424,15.456C6.784,16.096 6.4,16.992 6.4,17.984C6.4,18.016 6.368,18.08 6.368,18.112C6.396,18.955 6.71,19.726 7.215,20.331C7.883,21.144 8.898,21.664 10.04,21.664L19.512,21.664C20.696,21.664 21.656,20.704 21.656,19.52C21.656,18.741 21.235,18.017 20.55,17.64C20.486,17.602 20.42,17.567 20.352,17.536C20.33,17.527 20.309,17.517 20.288,17.506C19.985,17.317 19.839,16.95 19.896,16.608C19.928,16.352 19.96,16.128 19.96,15.904C19.96,14.36 19.103,13.009 17.842,12.301C17.233,11.947 16.527,11.744 15.776,11.744C14.464,11.744 13.28,12.352 12.512,13.344C12.704,13.44 12.864,13.568 13.024,13.664C13.44,13.952 13.536,14.496 13.28,14.912C13.204,15.021 13.111,15.109 13.007,15.173C12.724,15.322 12.375,15.313 12.088,15.136C11.8,14.944 11.384,14.688 10.968,14.528C10.936,14.528 10.904,14.496 10.872,14.496C10.84,14.496 10.808,14.464 10.776,14.464C10.52,14.4 10.264,14.368 10.04,14.368C9.557,14.368 9.096,14.467 8.673,14.642Z",
        fill: l.multiColor ? l.secondaryColor || "#666666" : l.color
      }, null, 8, p1)
    ], 16, c1));
  }
}), L1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], $1 = { key: 0 }, g1 = ["fill"], M1 = ["fill"], b1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-east"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", $1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), v1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], Z1 = { key: 0 }, N1 = ["fill"], z1 = ["fill"], B1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-north-east"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", Z1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), W1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], S1 = { key: 0 }, k1 = ["fill"], j1 = ["fill"], F1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-north-west"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", S1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), R1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], E1 = { key: 0 }, H1 = ["fill"], T1 = ["fill"], q1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-north"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), A1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], G1 = { key: 0 }, Q1 = ["fill"], D1 = ["fill"], U1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-south-east"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", G1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), V1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], P1 = { key: 0 }, I1 = ["fill"], J1 = ["fill"], K1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-south-west"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", P1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), O1 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], X1 = { key: 0 }, Y1 = ["fill"], _1 = ["fill"], x1 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-south"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", X1, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), l2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], e2 = { key: 0 }, o2 = ["fill"], r2 = ["fill"], t2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass-west"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", e2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), i2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], a2 = { key: 0 }, s2 = ["fill"], C2 = ["fill"], n2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-compass"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", a2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), u2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], d2 = { key: 0 }, h2 = ["fill"], m2 = ["fill"], c2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-fahrenheit"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", d2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), f2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], y2 = { key: 0 }, p2 = ["fill"], w2 = ["fill"], L2 = /* @__PURE__ */ n({
  __name: "WeatherFog",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-fog"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", y2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), $2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], g2 = { key: 0 }, M2 = ["fill"], b2 = ["fill"], v2 = /* @__PURE__ */ n({
  __name: "WeatherHail",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-hail"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", g2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), Z2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], N2 = { key: 0 }, z2 = ["fill"], B2 = ["fill"], W2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-lightning"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", N2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), S2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], k2 = { key: 0 }, j2 = ["fill"], F2 = ["fill"], R2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-cloud-lightning"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", k2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), E2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], H2 = { key: 0 }, T2 = ["fill"], q2 = ["fill"], A2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-cloud-rain"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", H2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), G2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], Q2 = { key: 0 }, D2 = ["fill"], U2 = ["fill"], V2 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-cloud-snow"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-cloud-wind"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", I2, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), X2 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], Y2 = { key: 0 }, _2 = ["fill"], x2 = ["fill"], l6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-cloud"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), e6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], o6 = { key: 0 }, r6 = ["fill"], t6 = ["fill"], i6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-first-quarter"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", o6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), a6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], s6 = { key: 0 }, C6 = ["fill"], n6 = ["fill"], u6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-fog"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", s6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), d6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], h6 = { key: 0 }, m6 = ["fill"], c6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-fullmoon"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", h6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), f6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], y6 = { key: 0 }, p6 = ["fill"], w6 = ["fill"], L6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-last-quarter"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", y6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), $6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], g6 = { key: 0 }, M6 = ["fill"], b6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-newmoon"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", g6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), v6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], Z6 = { key: 0 }, N6 = ["fill"], z6 = ["fill"], B6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-waning-crescent"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", Z6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), W6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], S6 = { key: 0 }, k6 = ["fill"], j6 = ["fill"], F6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-waning-gibbous"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), R6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], E6 = { key: 0 }, H6 = ["fill"], T6 = ["fill"], q6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-waxing-crescent"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", E6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), A6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], G6 = { key: 0 }, Q6 = ["fill"], D6 = ["fill"], U6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon-waxing-gibbous"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), V6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], P6 = { key: 0 }, I6 = ["fill"], J6 = /* @__PURE__ */ n({
  __name: "WeatherMoon",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-moon"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", P6, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), K6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], O6 = { key: 0 }, X6 = ["fill"], Y6 = ["fill"], _6 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-rainbow"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), x6 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], l4 = { key: 0 }, e4 = ["fill"], o4 = ["fill"], r4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-raindrop"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", l4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), t4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], i4 = { key: 0 }, a4 = ["fill"], s4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-refresh"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", i4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), C4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], n4 = { key: 0 }, u4 = ["fill"], d4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-snowflake"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", n4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), h4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], m4 = { key: 0 }, c4 = ["fill"], f4 = ["fill"], y4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-cloud-lightning"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", m4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), p4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], w4 = { key: 0 }, L4 = ["fill"], $4 = ["fill"], g4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-cloud-rain"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-cloud-snow"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-cloud-wind"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), j4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], F4 = { key: 0 }, R4 = ["fill"], E4 = ["fill"], H4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-cloud"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-fog"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", q4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), D4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], U4 = { key: 0 }, V4 = ["fill"], P4 = ["fill"], I4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-low"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", U4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), J4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], K4 = { key: 0 }, O4 = ["fill"], X4 = ["fill"], Y4 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun-medium"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", K4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), _4 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], x4 = { key: 0 }, l8 = ["fill"], e8 = /* @__PURE__ */ n({
  __name: "WeatherSun",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sun"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", x4, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), o8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], r8 = { key: 0 }, t8 = ["fill"], i8 = ["fill"], a8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sunrise"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", r8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), s8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], C8 = { key: 0 }, n8 = ["fill"], u8 = ["fill"], d8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-sunset"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", C8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), h8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], m8 = { key: 0 }, c8 = ["fill"], f8 = ["fill"], y8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-thermometer-cold"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", m8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), p8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], w8 = { key: 0 }, L8 = ["fill"], $8 = ["fill"], g8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-thermometer-hot"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", w8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), M8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], b8 = { key: 0 }, v8 = ["fill"], Z8 = ["fill"], N8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-thermometer-medium"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", b8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), z8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], B8 = { key: 0 }, W8 = ["fill"], S8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-tornado"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
...
}), k8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], j8 = { key: 0 }, F8 = ["fill"], R8 = ["fill"], E8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-umbrella"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", j8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), H8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], T8 = { key: 0 }, q8 = ["fill"], A8 = ["fill"], G8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-wind-high"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", T8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), Q8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], D8 = { key: 0 }, U8 = ["fill"], V8 = ["fill"], P8 = /* @__PURE__ */ n({
  __name: "WeatherWind",
  props: {
    size: { default: 24 },
    color: { default: "currentColor" },
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-wind"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
    ...
    return (l, m) => (t(), r("svg", u({
      ...
      l.title ? (t(), r("title", D8, h(l.title), 1)) : d("", !0),
      C("path", {
...
}), I8 = ["width", "height", "fill", "role", "aria-hidden", "aria-label"], J8 = { key: 0 }, K8 = ["fill"], O8 = ["fill"], X8 = /* @__PURE__ */ n({
  ...
  setup(i) {
    const e = i, a = o(() => {
      const l = [e.className];
      return e.multiColor && l.push("weather-multi-color", "weather-windsock"), l.filter(Boolean).join(" ");
    }), s = o(() => e.multiColor ? {
      ...e.style,
      ...e.primaryColor && { "--weather-primary-fill": e.primaryColor },
      ...e.secondaryColor && { "--weather-secondary-fill": e.secondaryColor }
  ...
  clouds: w1,
  "compass-east": b1,
  "compass-north-east": B1,
  "compass-north-west": F1,
  "compass-north": q1,
  "compass-south-east": U1,
  "compass-south-west": K1,
  "compass-south": x1,
  "compass-west": t2,
  compass: n2,
  fahrenheit: c2,
  ...
  hail: v2,
  lightning: W2,
  "moon-cloud-lightning": R2,
  "moon-cloud-rain": A2,
  "moon-cloud-snow": V2,
  "moon-cloud-wind": O2,
  "moon-cloud": l6,
  "moon-first-quarter": i6,
  "moon-fog": u6,
  "moon-fullmoon": c6,
  "moon-last-quarter": L6,
  "moon-newmoon": b6,
  "moon-waning-crescent": B6,
  "moon-waning-gibbous": F6,
  "moon-waxing-crescent": q6,
  "moon-waxing-gibbous": U6,
  moon: J6,
  rainbow: _6,
  raindrop: r4,
  refresh: s4,
  snowflake: d4,
  "sun-cloud-lightning": y4,
  "sun-cloud-rain": g4,
  "sun-cloud-snow": N4,
  "sun-cloud-wind": k4,
  "sun-cloud": H4,
...
export {
  w as WeatherBarometer,
  b as WeatherCelsius,
  m1 as WeatherCloud,
  B as WeatherCloudDown,
  F as WeatherCloudFog,
  U as WeatherCloudRain,
  q as WeatherCloudRainSingle,
  x as WeatherCloudSnow,
  K as WeatherCloudSnowSingle,
  t1 as WeatherCloudUp,
  n1 as WeatherCloudWind,
  w1 as WeatherClouds,
  n2 as WeatherCompass,
  b1 as WeatherCompassEast,
  q1 as WeatherCompassNorth,
  B1 as WeatherCompassNorthEast,
  F1 as WeatherCompassNorthWest,
  x1 as WeatherCompassSouth,
  U1 as WeatherCompassSouthEast,
  K1 as WeatherCompassSouthWest,
  t2 as WeatherCompassWest,
  c2 as WeatherFahrenheit,
  L2 as WeatherFog,
  v2 as WeatherHail,
  W2 as WeatherLightning,
  J6 as WeatherMoon,
  l6 as WeatherMoonCloud,
  R2 as WeatherMoonCloudLightning,
  A2 as WeatherMoonCloudRain,
  V2 as WeatherMoonCloudSnow,
  O2 as WeatherMoonCloudWind,
  i6 as WeatherMoonFirstQuarter,
  u6 as WeatherMoonFog,
  c6 as WeatherMoonFullmoon,
  L6 as WeatherMoonLastQuarter,
  b6 as WeatherMoonNewmoon,
  B6 as WeatherMoonWaningCrescent,
  F6 as WeatherMoonWaningGibbous,
  q6 as WeatherMoonWaxingCrescent,
  U6 as WeatherMoonWaxingGibbous,
  _6 as WeatherRainbow,
  r4 as WeatherRaindrop,
  s4 as WeatherRefresh,
  d4 as WeatherSnowflake,
  e8 as WeatherSun,
  H4 as WeatherSunCloud,
  y4 as WeatherSunCloudLightning,
  g4 as WeatherSunCloudRain,
  N4 as WeatherSunCloudSnow,
  k4 as WeatherSunCloudWind,
  Q4 as WeatherSunFog,
  I4 as WeatherSunLow,
  Y4 as WeatherSunMedium,
  a8 as WeatherSunrise,
  d8 as WeatherSunset,
  y8 as WeatherThermometerCold,
  g8 as WeatherThermometerHot,
  N8 as WeatherThermometerMedium,
  S8 as WeatherTornado,
  E8 as WeatherUmbrella,
  P8 as WeatherWind,
  G8 as WeatherWindHigh,
  X8 as WeatherWindsock,
  _8 as iconComponents
};
