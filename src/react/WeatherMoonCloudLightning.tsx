...
export const WeatherMoonCloudLightning = React.forwardRef<SVGSVGElement, IconProps>(({
  size = 24,
  color = 'currentColor',
  multiColor = false,
  primaryColor,
  ...
  const combinedClassName = `${className || ''} ${multiColor ? 'weather-multi-color weather-moon-cloud-lightning' : ''}`.trim()
...
WeatherMoonCloudLightning.displayName = 'WeatherMoonCloudLightning'
