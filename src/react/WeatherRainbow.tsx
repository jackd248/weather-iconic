...
export const WeatherRainbow = React.forwardRef<SVGSVGElement, IconProps>(({
  size = 24,
  color = 'currentColor',
  multiColor = false,
  primaryColor,
  ...
  const combinedClassName = `${className || ''} ${multiColor ? 'weather-multi-color weather-rainbow' : ''}`.trim()
...
WeatherRainbow.displayName = 'WeatherRainbow'
