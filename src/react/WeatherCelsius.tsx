...
export const WeatherCelsius = React.forwardRef<SVGSVGElement, IconProps>(({
  size = 24,
  color = 'currentColor',
  multiColor = false,
  primaryColor,
  ...
  const combinedClassName = `${className || ''} ${multiColor ? 'weather-multi-color weather-celsius' : ''}`.trim()
...
WeatherCelsius.displayName = 'WeatherCelsius'
