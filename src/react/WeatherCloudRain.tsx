...
export const WeatherCloudRain = React.forwardRef<SVGSVGElement, IconProps>(({
  size = 24,
  color = 'currentColor',
  multiColor = false,
  primaryColor,
  ...
  const combinedClassName = `${className || ''} ${multiColor ? 'weather-multi-color weather-cloud-rain' : ''}`.trim()
...
WeatherCloudRain.displayName = 'WeatherCloudRain'
